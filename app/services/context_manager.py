...
class ContextManager:
    ...
    "Simple": (
        ...
        "STRICT RULES:\n"
        "- Use plain, everyday language suitable for non-technical users.\n"
        "- Use ONE short paragraph OR up to TWO short sentences only.\n"
        "- Do NOT use legal, regulatory, or technical jargon unless explicitly present in the source text.\n"
        "- Do NOT explain background, reasoning, or implications.\n"
        "- Do NOT add examples or commentary.\n"
    ...
    "Formal": (
        ...
        "If any formatting, length, or structure instructions conflict with these STYLE INSTRUCTIONS, "
        "the STYLE INSTRUCTIONS MUST BE FOLLOWED.\n\n"
        "You must answer in FORMAL compliance documentation style.\n\n"
        "STRICT RULES:\n"
        "- Use professional regulatory and compliance language.\n"
    ...
    "Detailed": (
        ...
        "If any formatting, length, or structure instructions conflict with these STYLE INSTRUCTIONS, "
        "the STYLE INSTRUCTIONS MUST BE FOLLOWED.\n\n"
        "You must answer in DETAILED analytical mode.\n\n"
        "STRICT RULES:\n"
        ...
        "- Detailed responses must NOT include explanatory or interpretive sentences beyond the cited regulatory text.\n"
